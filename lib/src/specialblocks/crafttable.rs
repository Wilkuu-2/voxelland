...
impl CraftTableInfo {
    pub fn craft_table_model_from_index(index: usize) -> &'static Vec<f32> {
        static models: Lazy<Vec<Vec<f32>>> = Lazy::new(|| {
            vec![
                ...
                rotate_coordinates_around_y_negative_90(
                    CraftTableInfo::base_craft_table_model(),
                    1,
                ),
                rotate_coordinates_around_y_negative_90(
                    CraftTableInfo::base_craft_table_model(),
    ...
    pub fn base_craft_table_model() -> &'static [f32] {
        static player_is_minus_z: [f32; 900] = [
            ...
            0.0,
            14.0,
            0.003607332706451416,
            0.0053150104358792305,
            0.005356699228286743,
            0.0,
            14.0,
            0.19119399785995483,
            ...
            0.0,
            14.0,
            0.001448303461074829,
            0.005315005779266357,
            0.7948340177536011,
            0.0,
            14.0,
            0.18903499841690063,
