...
impl LadderInfo {
    ...
    pub fn get_ladder_uvs() -> Vec<f32> {
        ...
        let uvs = vec![
            face.blx, face.bly, face.blx, face.bly, face.brx, face.bry, face.blx, face.bly,
            face.trx, face.tr_y, face.blx, face.bly, face.trx, face.tr_y, face.blx, face.bly,
            face.tlx, face.tly, face.blx, face.bly, face.blx, face.bly, face.blx, face.bly,
            face.blx, face.bly, face.blx, face.bly, face.brx, face.bry, face.blx, face.bly,
            face.trx, face.tr_y, face.blx, face.bly, face.trx, face.tr_y, face.blx, face.bly,
            face.tlx, face.tly, face.blx, face.bly, face.blx, face.bly, face.blx, face.bly,
        ];
    ...
    pub fn base_ladder_model() -> &'static [f32] {
        static player_is_minus_z: [f32; 60] = [
            1.0, 0.0, 1.0, 0.0, 14.0, 0.0, 0.0, 1.0, 0.0, 14.0, 0.0, 1.0, 1.0, 0.0, 14.0, 0.0, 1.0,
            1.0, 0.0, 14.0, 1.0, 1.0, 1.0, 0.0, 14.0, 1.0, 0.0, 1.0, 0.0, 14.0, 0.0, 0.0, 0.9, 0.0,
            14.0, 1.0, 0.0, 0.9, 0.0, 14.0, 1.0, 1.0, 0.9, 0.0, 14.0, 1.0, 1.0, 0.9, 0.0, 14.0,
            0.0, 1.0, 0.9, 0.0, 14.0, 0.0, 0.0, 0.9, 0.0, 14.0,
        ];
        &player_is_minus_z
    }
}
